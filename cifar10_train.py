...
class Train(object):
    ...
    def train(self):
        ...
        for step in xrange(FLAGS.train_steps):
            ...
            train_batch_hand, train_batch_head, train_batch_label_fa, train_batch_label_ges, train_batch_label_obj = \
                                self.generate_data_batch(train_data_list, FLAGS.train_batch_size, 'train')
...
def read_test_data():
    testing_img = io.imread('Image21.png')
...
if FLAGS.mode is 'test':
    ...
    test_accuracy = train.test(testing_img)
