...
| Feature | hyper-para | Accuracy |
|-------|----------|----------|
|obj + FA| `c=4_d=32_n=3_lr=0.05_lrd=0.004_wd=0.0007_k=0.5`| 0.581% |
|obj + FA| `c=4_d=32_n=3_lr=0.05_lrd=0.004_wd=0.0007_k=0.5`| **0.656%** |
|obj + FA| `c=4_d=32_n=3_lr=0.05_lrd=0.004_wd=0.0007_k=0.5`| 0.640% |
